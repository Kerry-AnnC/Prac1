...
def decrease(decreaseBTN):
	...
	GPIO.output(channelout_list, binaries[counter])
	#time.sleep(0.5)
GPIO.add_event_detect(5, GPIO.FALLING, callback=increase,bouncetime=300)
GPIO.add_event_detect(6, GPIO.FALLING, callback=decrease,bouncetime=300)
